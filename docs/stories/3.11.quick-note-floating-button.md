...
- [x] Task 11 – Testing (AC: 1–11)
  ...
  - [ ] Test manuel : widget, navigation sans fermeture, Cmd+J, liste, édition, auto-save.
- [x] Task 12 (QA): Rédiger les cas de test dans docs/stories/cases/3.11-test-cases.md.
- [ ] Task 13 (review): Lancer une review de code en fin de développement avant clôture.
